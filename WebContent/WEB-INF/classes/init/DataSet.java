...
public class DataSet {
	...
	public DataSet(){
		...
		dp3.setText("Cerco lavoro come educatrice: ho esperienze in vari settori, dall'animazione all'assistenza ad personam ed anche come educatrice in asilo nido. tel 320.0645731, Citt�: Sal�, Provincia: Brescia");
		entity_list3.clear();
		dbpedia_list3.clear();
		...
		dp10.setText("C.V. Istituto tecnico industriale Enrico Fermi 73/100 informatica et� 21 cerco lavoro come magazziniere operaio barista cameriere informatico iacchetti.daniele@gmail.com");
		entity_list10.clear();
...
//		dp18.setText("MANOVALE Pittore Controsoffitti Pavimentista Piastrellista del mestiere da generazione di famiglia cerca lavoro anche a giornata Max seriet� e manifattura Claudio tel.333 8820598");
//		entity_list18.clear();
...
//		cv.add("Cerco lavoro come educatrice: ho esperienze in vari settori, dall'animazione all'assistenza ad personam ed anche come educatrice in asilo nido. tel 320.0645731, Citt�: Sal�, Provincia: Brescia");
...
//		cv.add("Carlo Bianchi, Ruolo: IT Manager, Responsabilit�:  - Gestione di un parco macchine di circa 70 client. - Sviluppo, manutenzione e personalizzazione di applicativi Ad-hoc. - Implementazione e gestione di un architettura complessa che prevede la convivenza di  Linux e Windows sia dal lato client che dal lato server.- Help desk di primo e secondo livello, configurazione, manutenzione dei sistemi informativi aziendali a livello sistemistico. - Implementazione del gestionale. - Gestione fornitori.");
//		cv.add("C.V. Istituto tecnico industriale Enrico Fermi 73/100 informatica et� 21 cerco lavoro come magazziniere operaio barista cameriere informatico iacchetti.daniele@gmail.com");
...
//		cv.add("MANOVALE Pittore Controsoffitti Pavimentista Piastrellista del mestiere da generazione di famiglia cerca lavoro anche a giornata Max seriet� e manifattura Claudio tel.333 8820598");
